...
const CONTEXT_LAYERS = [
  ...
  },
  {
    ...
    desc: "AST-level code graph with 2,234 nodes and 2,314 edges. Cross-file relationships, community clusters, and semantic navigation — no vector DB required.",
...
# → returns ~15 nodes instead of loading 2,234
