...
#   config/onboarding-o6-contract.json → website/data/onboarding-o6.json
#   config/onboarding-o6-policy.json → website/data/onboarding-o6-policy.json
#   config/onboarding-o6-state-schema.json → website/data/onboarding-o6-state-schema.json
...
sync_file "$ROOT/config/onboarding-o6-contract.json" "$DATA_DIR/onboarding-o6.json"
sync_file "$ROOT/config/onboarding-o6-policy.json" "$DATA_DIR/onboarding-o6-policy.json"
sync_file "$ROOT/config/onboarding-o6-state-schema.json" "$DATA_DIR/onboarding-o6-state-schema.json"
