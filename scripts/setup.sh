...
echo "  2. Run: make health    — verify your configuration"
echo "  3. Run: opencode       — start the AI workflow"
echo
echo "  Quick reference:"
echo "    make validate        — validate all skills before committing"
echo "    make sync            — sync website/data/ after changing skills"
echo "    make graph           — update the knowledge graph"
echo "    make help            — list all available commands"
echo
